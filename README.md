...
2) Open `.codex/config.toml` and replace the project path inside the brackets with your local repo path.
...
After copying the config, open `.codex/config.toml` and replace the project path inside the brackets with your local repo path.
